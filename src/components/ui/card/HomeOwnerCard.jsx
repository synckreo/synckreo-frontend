    ...
    <div className="bg-gray-100 p-4 w-full rounded-lg">
      ...
      <div className="mt-4 flex flex-col items-center gap-4 lg:flex-row">
        {filters.tag.map((tags)=>(
            <span className="active:text-primary hover:text-primary hover:border-primary active:border-primary cursor-pointer rounded-[20px] border border-gray-800/10 px-4 py-2 text-sm font-medium" 
            key={tags}>{tags}</span>
        ))}
      </div>
