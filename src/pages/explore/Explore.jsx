...
export const Explore = () =>  (
  ...
  <section className="mt-24 h-min flex flex-col justify-center">
    <div className="flex sm:flex-col md:flex-col lg:flex-row items-center gap-20 mb-10">
      ...
      <span className="block text-primary" style={{ height: '1.2em', overflow: 'hidden'  }}>Connections</span>
      <span className="block" style={{ height: '1.2em', overflow: 'hidden' }}>That Last</span>
      </h1>
      </div>
      <div className="flex flex-1 flex-col gap-4">
        <p>Linking professionals, companies and clients in one trusted construction network.</p>
        <Search
    ...
    {/* Image Bannner */}
    <div>
      <img className="w-full h-auto rounded-3xl" src={explore_page_banner} alt="Banner" />
    </div>
  </section>
  ...
  <section className="flex flex-col items-center">
    <div className="max-w-4xl mt-24 mb-12">
      ...
      <p className="text-center text-[#333333]">From skilled tradespeople and trusted contractors to proactive homeowners and experienced developers — our network brings together everyone who makes construction happen. </p>
    </div>
    ...
    <div className="w-full">
      ...
      variant="explore"
      size="contact"
      icon={<img src={arrowIcon} alt="arrow" className="w-4 h-4" />}
      iconPosition="right"
      />
      </div>
      {/* Card Container */}
